...
void main() => runApp(GarciaApp());

class GarciaApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: EsScaffold(title: "Flutter en español Garcia"),
    ); //Fin de MaterialApp
  } //fin widget build
} // fin GarciaApp
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
          ...
          Text('Drawer 1 Garcia'),
        ]), //Fin de columna
      ), //Fin drawer 1
      endDrawer: Drawer(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
          FlutterLogo(size: 100.0),
          Text('Drawer 2 Garcia end'),
        ]), //Fin de columna
      ), //Fin endDrawer 2
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text('bottomNavigationBar con BottomAppBar Garcia')
            ], // Fin <Widget>
          ), //Fin Row
        ), //Fin Container
      ), //Fin bottom aPPBar
